...
class GalleryController extends Controller
{
    ...
    {
        $galleries = Gallery::orderBy('id', 'ASC')->paginate(5);
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            [
                'image_url.required' => 'gambar harus dipilih',
            ]
        );
        ...
        foreach ($request->image_url as $image_url) {
            ...
            if ($save) {
                $image_url->storeAs('public/gambar', $fileNameToStore);
            }
        }
    ...
    {
        // Delete image file
        Storage::delete('/public/gambar/' . $gallery->image_url);

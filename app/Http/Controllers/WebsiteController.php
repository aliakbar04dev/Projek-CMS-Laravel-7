...
class WebsiteController extends Controller
{
    ...
    public function category($slug)
    {
        ...
        if ($category) {
            $posts = $category->posts()->orderBy('posts.id', 'ASC')->where('is_published', '1')->paginate(5);
    ...
    public function submitContactForm(Request $request)
    {
        ...
        Mail::to('akbarali04id@gmail.com')->send(new VisitorContact($data));

        Session::flash('message', 'Terima Kasih Atas Saran Dan Kritik Anda');

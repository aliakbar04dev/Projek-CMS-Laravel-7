...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        ...
        <a class="navbar-brand" href="{{ url('/') }}">Projek Laravel CMS</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('contact.show') }}">Hubungi Saya</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-md-10 mx-auto">
                <ul class="list-inline text-center">
                    <li class="list-inline-item">
                        <a href="#">
                <span class="fa-stack fa-lg"  style="color: #d56993">
                ...
                <p class="copyright text-muted">Copyright &copy; aliakbar04dev 2020</p>
            </div>
        </div>
    </div>
</footer>
